...
| probe-qwen2.5-7b-instruct-T1-max_rolling_means | UNVALIDATED | UNVALIDATED | UNVALIDATED | UNVALIDATED | UNVALIDATED | **REFUSED** | **REFUSED** |
| probe-qwen2.5-7b-instruct-T1-mean_pool | UNVALIDATED | UNVALIDATED | UNVALIDATED | UNVALIDATED | UNVALIDATED | **REFUSED** | **REFUSED** |

Cell states: VALID 9, REFUSED 6, UNVALIDATED 34. 34 of 49 cells have never been measured, which is the expected shape: UNVALIDATED is the modal state in production.
...
| `probe-qwen2.5-7b-instruct-T1-max_rolling_means` | `triviaqa-600` | REFUSED | 0.785 [0.750, 0.821] (95% CI, n=600) | 0.083 [0.054, 0.117] (95% CI, n=600) | 0.920 [0.800, 1.000] (95% CI, n=600) | 1.993 [1.286, 2.819] (95% CI, n=600) — 92% of the 2.17 ceiling at base rate 0.462 | 600 |
| `probe-qwen2.5-7b-instruct-T1-mean_pool` | `triviaqa-600` | REFUSED | 0.785 [0.750, 0.821] (95% CI, n=600) | 0.079 [0.050, 0.113] (95% CI, n=600) | 0.917 [0.786, 1.000] (95% CI, n=600) | 1.986 [1.254, 2.835] (95% CI, n=600) — 92% of the 2.17 ceiling at base rate 0.462 | 600 |
...
- git commit `49f4f78ae735a8eb83965f837c93423e60c9543b`
- dirty tree: `True`
- seed `1729`
- generated `2026-08-26T19:49:38+00:00`
