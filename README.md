...
| `tests/` | 678 tests, including the ones that enforce this README |
...
| `make test` | `python -m pytest tests/ -q` | CPU | ~10 min | 678 tests green |
...
| [DECISIONS.md](DECISIONS.md) | 114 append-only entries — "why did you do it that way?" |
