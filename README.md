...
| `tests/` | 714 tests, including the ones that enforce this README |
...
| `make test` | `python -m pytest tests/ -q` | CPU | ~10 min | 714 tests green |
...
| [DECISIONS.md](DECISIONS.md) | 116 append-only entries — "why did you do it that way?" |
