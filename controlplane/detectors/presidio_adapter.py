...
class PresidioDetector:
    ...
    :func:`~controlplane.validation.text_runner.validate_text_detector` takes this class
    unmodified.
    ...
    def find(self, text: str) -> tuple[PiiMatch, ...]:
        ...
        Returns the same :class:`~controlplane.detectors.pii_reference.PiiMatch` the
